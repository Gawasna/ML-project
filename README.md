...
* **`entry.py`**: Công cụ trích xuất CDN luồng M3U8 từ các URL. Phân tích, lựa chọn danh tính đóng góp (hung, quang, hoang) và ghi log chặn trùng lặp qua hệ thống tệp lưu `targets.txt`.
